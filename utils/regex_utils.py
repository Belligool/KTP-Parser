...
NAMA_REGEX = re.compile(r'(?i:Nama|Narna|Name|Nema|Hama|Harna|Hame|Hema|Mama|Marna|Mame|Mema|Noma|Namo|Naama|Namaa|Nma|Naina|Naoa|Naua|Narna|Narne|Narno|Narn|Narnr)\s*[:;]?\s*[^A-Za-z]{0,3}\s*([A-Z]{2,}(?:[\s\.,]+[A-Z]{2,}){0,9})')
