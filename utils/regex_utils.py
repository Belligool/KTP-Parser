...
NAMA_REGEX = re.compile(r'(?:Nama|Narna|Name|Nema|Hama|Harna|Hame|Hema|Mama|Marna|Mame|Mema|Noma|Namo|Naama|Namaa|Nma|Naina|Naoa|Naua|Narna|Narne|Narno|Narn|Narnr)\s*[:;]?\s*([A-Z\s\.\,]+)', re.IGNORECASE)
